...
document.addEventListener('DOMContentLoaded', () => {
    const elementsToAnimate = document.querySelectorAll('.about-text, .stat, .skill-category, .project-card, .cert-card');
...
if (contactForm) {
    contactForm.addEventListener('submit', async (e) => {
        ...
        try {
            // Submit to Formspree using obfuscated endpoint
            const endpoint = atob('aHR0cHM6Ly9mb3Jtc3ByZWUuaW8vZi94bm5idmpkZw==');
